...
//
    ...
    {
        static auto s_selfInstance = new TraceLogger();
...
//
    void TraceLogger::LogLineWidthChanged()
    {
        ...
        LoggingFields* fields = winrt::make<LoggingFields>();
        fields->AddString(CALC_MODE, GRAPHING_MODE);
        //TraceLoggingCommon::GetInstance()->LogLevel2Event(StringReference(EVENT_NAME_LINE_WIDTH_CHANGED), fields);
        //TraceLogging::TraceLoggingCommon::GetInstance()->LogLevel2Event(EVENT_NAME_LINE_WIDTH_CHANGED, fields);
    }
}
